...
- (void)layoutSubviews
{
    ...
    CGRect rectLeft = CGRectMake(5, [UIApplication sharedApplication].statusBarFrame.size.height, 44, 44);
    CGRect rectRight = CGRectMake(rect.size.width - 44, [UIApplication sharedApplication].statusBarFrame.size.height, 40, 40);
 

    [self.backButton setFrame:rectLeft];
    [self.stateButton setFrame:rectRight];
}
...
//    rect.origin.y = [UIApplication sharedApplication].statusBarFrame.size.height;
    rect.size.height = 44.0+[UIApplication sharedApplication].statusBarFrame.size.height;
